    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                <h4 className="text-lg font-bold text-slate-800 mb-1 flex items-center">
                ...
                <p className="text-sm text-slate-500 mb-3 ml-9">Anything specific we should know? (Optional)</p>
                <textarea
                    className="w-full form-input resize-none"
                    rows="3"
                    placeholder="E.g., wheelchair access, dietary restrictions, room on lower floor..."
                    value={concerns}
