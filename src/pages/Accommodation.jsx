    ...
    if (matched.length > 0) {
      results.push({
        room: {
          ...
          roomType: (row['Room Type'] || row['RoomType'] || '').toString().trim(),
          extraBed: (row['Extra Bed Provided'] || row['ExtraBed'] || '').toString().trim(),
          daysRented: (row['No. of Days Rented'] || row['DaysRented'] || '').toString().trim(),
          ...
          <div className="animate-fade-in">
            ...
            {!notFound && roomResults.length > 0 && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-md border border-amber-100 p-5 space-y-4 animate-fade-in">
                  ...
                  {/* Lift notice (common message) */}
                  <div className="bg-indigo-50/50 border border-indigo-100/60 rounded-xl px-4 py-2.5 flex items-center gap-2.5 text-xs text-indigo-800">
                    ...
                    <span><strong>General Info:</strong> Devotees can use the lift in the Hotel.</span>
                  </div>
                </div>
